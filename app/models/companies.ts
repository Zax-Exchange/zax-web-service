  ...
  implements companiesAttributes
{
  ...
  removeProjects!: Sequelize.HasManyRemoveAssociationsMixin<
    projects,
    projectsId
  >;
  ...
  // companies hasMany pending_join_requests via companyId
  pending_join_requests!: pending_join_requests[];
  getPending_join_requests!: Sequelize.HasManyGetAssociationsMixin<pending_join_requests>;
  addPending_join_requests!: Sequelize.HasManyAddAssociationMixin<
    pending_join_requests,
    pending_join_requestsId
  >;
