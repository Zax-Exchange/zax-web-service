...
export type component_specsOptionalAttributes = "thickness" | "flute" | "manufacturingProcess" | "color" | "createdAt" | "updatedAt";
export type component_specsCreationAttributes = Optional<component_specsAttributes, component_specsOptionalAttributes>;

export class component_specs extends Model<component_specsAttributes, component_specsCreationAttributes> implements component_specsAttributes {
  id!: string;
  projectComponentId!: string;
  productName!: string;
  thickness?: string;
  ...
  setProjectComponent!: Sequelize.BelongsToSetAssociationMixin<project_bid_components, project_bid_componentsId>;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof component_specs {
    return sequelize.define('component_specs', {
    id: {
      type: DataTypes.UUID,
      allowNull: false,
      primaryKey: true
